        ...
        <ScrollAnimation animateIn="flipInX">
          <div className="project">
            ...
            <div className="body">
              ...
              <p>Proposed technical feasibility solutions for new
                  system designs and suggested options for
                  performance improvement of technical
                  components.
                  Maintained computer systems, installed and
                  upgraded new systems.
                  Collaborated with customers to define systems
                  engineering technical specifications and design
                  parameters.
                  Resolved conflicting design and system
                  requirements during new equipment installation</p>
            </div>
            <footer> <ul className="tech-list"> <li>TCS Adibatla, Hyderabad</li> <li>2021-06 -
            2022-11</li></ul> </footer>
          </div>
        </ScrollAnimation>
